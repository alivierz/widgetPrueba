...
addEventListener('click', (event) =>{
    if(event.target == element2[0]){
        ...
        <div id="chinchin-alivier" style="position: fixed; background-color: rgba( 255, 255, 255, .8);min-height: 100%;min-width: 100%;display: flex;justify-content: center;align-items: center;top: 0;z-index: 1000;">
