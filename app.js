...
addEventListener('click', (event) =>{
    if(event.target == element2[0]){
        ...
        <div id="chinchin-alivier" style="position: fixed; background-color: rgba( 147, 147, 147, .8);min-height: 100%;min-width: 100%;display: flex;justify-content: center;align-items: center;top: 0;z-index: 10000;">
